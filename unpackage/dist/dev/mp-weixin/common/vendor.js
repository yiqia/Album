...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__D7C8FAB" };exports.default = _default;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var Server_url = getApp().globalData.url; //定义公共 url
module.exports = {
  get: function get(option) {//get请求封装
  ...
  post: function post(option) {//postt请求封装
    return new Promise(function (resolve, reject) {
      wx.request({
        url: Server_url + option.url,
        data: option.data,
  ...
  sget: function sget(option) {//get请求封装
    return new Promise(function (resolve, reject) {
  ...
  http: function http(option) {//post请求封装
    return new Promise(function (resolve, reject) {
      if (uni.getStorageSync("session") == "" || uni.getStorageSync("session") == undefined) {
        uni.showToast({
          title: "未登录",
